...
export default class Imageination extends React.Component {
	...
	*/
	showImage = (image) => {
		this.holder.style.background = `url('${image}')`;
	}
	...
	*/
	...
	render() {
		const size = this.props.scaleSize;
		const demensions = { height: `${size}px`, width: `${size}px` }
		return(
			<div className="imagenation">
				<div className="holder"
					onClick={this.triggerFileInput} style={demensions}
					ref={(div) => this.holder = div}>
